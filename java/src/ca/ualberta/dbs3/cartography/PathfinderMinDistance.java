...
/**
 * The <code>PathfinderMinDistance</code> class is responsible for finding
 * paths between given points on a map that minimize the Euclidean distance
 * travelled.
 */
public class PathfinderMinDistance extends PathfinderOptimal {
    /**
     * Creates a new <code>PathfinderMinDistance</code> that operates on the
     * given map.
     *
     * @param map the map on which this pathfinder operates.
     */
    public PathfinderMinDistance(Map map) {
        super(map);
    }
