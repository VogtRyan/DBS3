...
/**
 * The <code>GeodesicFinderMinAngle</code> class is responsible for finding
 * {@link Geodesic}s between two segments such that angle change is minimized.
 */
public class GeodesicFinderMinAngle extends GeodesicFinder {
    /**
     * Creates a new <code>GeodesicFinderMinAngle</code> that operates on the
     * given map.
     *
     * @param map the map on which this search algorithm operates.
     */
    public GeodesicFinderMinAngle(Map map) {
        super(map, "minimal angle change");
    }
