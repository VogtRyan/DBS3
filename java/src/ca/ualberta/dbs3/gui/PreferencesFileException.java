...
/**
 * The <code>PreferencesFileException</code> class represents an error that
 * occurred while attempting to read a {@link Preferences} file.
 */
public class PreferencesFileException extends Exception {
     ...
     */
    public PreferencesFileException(String message) {
        super(message);
    }
}
