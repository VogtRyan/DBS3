...
/**
 * The <code>PreferencesObserver</code> class represents an observer that will
 * be notified when a {@link Preferences} object is changed.
 */
public interface PreferencesObserver {
    /**
     * Called when a <code>Preferences</code> object that is being observed is
     * modified.
     *
